...
import Slider from "../../pages/slidingonscroll"
    ...
    <div className='bg-blue-300  lg:h-96 flex flex-col rounded-3xl p-2 items-center'>
                ...
                <div className='flex font-semibold flex-col gap-5 lg:p-10'>
                    <Slider Name={   <p>This portal is an initiative of the Government of India to facilitate victims/complainants to report cyber crime complaints online. This portal caters to complaints pertaining to cyber crimes only with a special focus on cyber crimes against women and children. Complaints reported on this portal are dealt with by law enforcement agencies/police based on the information available in the complaints. It is imperative to provide correct and accurate details while filing a complaint for prompt action.</p>} />
                    <Slider Name2={    <p>Please contact the local police in case of an emergency or for reporting crimes other than cyber crimes. The national police helpline number is 112. The national women helpline number is 181, and the Cyber Crime Helpline is 1930.</p>} />
