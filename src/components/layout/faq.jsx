...
const Accordion = () => {
  ...
  <section className="w-full overflow-hidden">
    <div className="grid grid-flow-row grid-cols-1 gap-10 lg:gap-0 lg:mb-0 mb-10 md:grid-cols-2 p-10 md:p-10 lg:p-20 h-screen">
        <div className="flex flex-col justify-between">
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-semibold">
                <span className="flex items-center">Frequently<FaHandPointRight className="text-2xl md:text-4xl lg:text-5xl" /></span> Asked Questions
            </h1>
        </div>
