...
const project = () => {
  return (
      <div>
          <div className='grid lg:h-screen grid-flow-cols grid-cols-2'>
              <div className='flex justify-center  items-center'>
                <img src={project1} alt="foundation" className='lg:w-3/4 rounded-2xl'/>
              </div>
            <div className='bg-orange-500 lg:p-20 flex flex-col gap-10  text-white '>
                  <h1 className='lg:text-6xl font-bold '>PROJECTS & ACTIVITIES</h1>
