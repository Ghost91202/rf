...
import Getintouch from "../../assets/images.jpg"
                ...
                <div
                    ...
                    <div className="flex flex-col justify-between">
                        <div>
                            ...
                            <div className="text-gray-700 flex mt-8">
                                Hate forms? Send us an  <a
                                    className="font leading-relaxed flex gap-1 whitespace-nowrap uppercase border-b-2 hover:border-blue-500 ml-2 mr-2"
