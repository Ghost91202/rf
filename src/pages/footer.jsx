...
const Footer = () => {
    return (
//         <div classNameName='h-auto w-screen overflow-x-hidden  flex  flex-col p-5 lg:gap-10 bg-orange-600'>
//             <div classNameName='h-60 w-screen flex flex-col gap-10 justify-center items-center'>
//                 <img src={Logo} alt="rahil foundation" classNameName=' h-32 items-center' />
//                 <h1>
//                     <Link to="#" classNameName='font-bold lg:text-3xl text-lg hover:underline text-orange-600 bg-white rounded-2xl p-2'>MAKE A DONATION</Link></h1>
//             </div>
// <div classNameName='flex lg:flex-row flex-col w-screen justify-between gap-10 p-10 lg:p-24'>
//                 <div>
//                     <h1>
//                         <Link to="/about" classNameName='lg:text-3xl text-lg hover:underline font-bold text-white'>ABOUT</Link>
//                 </h1>
//                     <h1>
//                         <Link to="/about" classNameName='lg:text-3xl text-lg hover:underline font-bold text-white'>THE ORGANIZATION</Link>
//                 </h1>
//                     <h1>
//                         <Link to="/about" classNameName='lg:text-3xl text-lg hover:underline font-bold text-white'>WHAT WE DO</Link>
//                 </h1>
//                     <h1>
//                         <Link to="/about" classNameName='lg:text-3xl text-lg hover:underline font-bold text-white'>TAKE PART</Link>
//                 </h1>
//                     <h1>
//                         <Link to="/about" classNameName='lg:text-3xl text-lg hover:underline font-bold text-white'>BLOG</Link>
//                 </h1>
//                     <h1>
//                         <Link to="/about" classNameName='lg:text-3xl text-lg hover:underline font-bold text-white'>CONTACT</Link>
//                 </h1>

//                 </div>
//                <Map/>
//                 <div classNameName='text-white font-bold gap-5  flex flex-col '>
//                     <div classNameName='flex flex-col gap-3'>
//                          <h1 classNameName='lg:text-3xl text-lg hover:underline font-bold text-start'>
//                         ADDRESS
//                     </h1>
//                     <h1 classNameName='text-lg'>
...
//             </div>
//             <div classNameName=' w-screen flex flex-col  text-white gap-3 justify-center items-center'>

//             <div classNameName=' w-screen flex lg:text-3xl text-lg text-white gap-10 justify-center items-center'>
...
//                 </div>
//                 <h1>
//                     <Link classNameName='text-lg hover:underline'>privacy & policies</Link>
//                 </h1>
//             </div>
            ...
            <div className="flex flex-col">
                <div className="flex mt-24 mb-12 flex-row justify-between">
                    ...
                    <div className="flex flex-row space-x-8 items-center justify-between">
                        <Link  to="https://www.facebook.com/rahilfoundation"  target='blank'>
                        ...
                        <Link to="https://www.instagram.com/rahil_foundation/"  target='blank'>
                        ...
                        <Link to="https://www.youtube.com/@RahilFoundation" target='blank'>
